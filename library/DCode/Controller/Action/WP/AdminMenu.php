...
abstract class DCode_Controller_Action_WP_AdminMenu extends DCode_Controller_Action_WP_Abstract
{
	...
	{
		$project = new Project ( $this->application () );
		$project = new Project ( $this->application () , $project->readme () );
		$this->view->project_readme = $project->blocks ();
		$this->view->project_readme = $this->view->project_readme [0];
		$project = new Project ( $this->application () , $project->plugin () );
	...
	public function setup ()
	{
		...
		{
			case 'Tools' :
				add_management_page ( $this->title , $this->title , 'administrator' , 'DCode_' . $this->adminMenuTitle . '_' . $this->title , array ( 
					$this , 'controller' 
				) );
				break;
			case 'SuperAdmin' :
				add_submenu_page ( 'wpmu-admin.php' , $this->title , $this->title , 'administrator' , 'DCode_' . $this->adminMenuTitle . '_' . $this->title , array ( 
					$this , 'controller' 
				) );
				break;
			case 'Dashboard' :
				add_dashboard_page ( $this->title , $this->title , 'administrator' , 'DCode_' . $this->adminMenuTitle . '_' . $this->title , array ( 
					$this , 'controller' 
				) );
				break;
			case 'Posts' :
				add_posts_page ( $this->title , $this->title , 'administrator' , 'DCode_' . $this->adminMenuTitle . '_' . $this->title , array ( 
					$this , 'controller' 
				) );
				break;
			case 'Pages' :
				add_Pages_page ( $this->title , $this->title , 'administrator' , 'DCode_' . $this->adminMenuTitle . '_' . $this->title , array ( 
					$this , 'controller' 
				) );
				break;
			case 'Appearance' :
				add_theme_page ( $this->title , $this->title , 'administrator' , 'DCode_' . $this->adminMenuTitle . '_' . $this->title , array ( 
					$this , 'controller' 
				) );
				break;
			case 'Comments' :
				add_comments_page ( $this->title , $this->title , 'administrator' , 'DCode_' . $this->adminMenuTitle . '_' . $this->title , array ( 
					$this , 'controller' 
				) );
				break;
			case 'Media' :
				add_media_page ( $this->title , $this->title , 'administrator' , 'DCode_' . $this->adminMenuTitle . '_' . $this->title , array ( 
					$this , 'controller' 
				) );
				break;
			case 'Settings' :
				add_options_page ( $this->title , $this->title , 'administrator' , 'DCode_' . $this->adminMenuTitle . '_' . $this->title , array ( 
					$this , 'controller' 
				) );
				break;
			case 'Users' :
				...
				break;
			case 'Links' :
				add_submenu_page ( 'users.php' , $this->title , $this->title , 'administrator' , 'DCode_' . $this->adminMenuTitle . '_' . $this->title , array ( 
					$this , 'controller' 
				) );
				break;
			case 'Plugins' :
				add_submenu_page ( 'plugins.php' , $this->title , $this->title , 'administrator' , 'DCode_' . $this->adminMenuTitle . '_' . $this->title , array ( 
					$this , 'controller' 
				) );
				break;
			case 'SandBox' :
				if (DCode_Debug::dodebug ())
				{
					if ($this->title == $this->adminMenuTitle)
					{
						if (self::$sandbox_shown === false)
						{
							add_menu_page ( $this->adminMenuTitle , $this->title , 'administrator' , 'DCode_' . $this->adminMenuTitle , array ( 
								$this , 'controller' 
							) );
					...
					{
						add_submenu_page ( 'DCode_' . $this->adminMenuTitle , $this->adminMenuTitle , $this->title , 'administrator' , 'DCode_' . $this->adminMenuTitle . '_' . $this->title , array ( 
							$this , 'controller' 
						) );
					}
				}
