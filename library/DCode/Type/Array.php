<?php
/**
 * user array, like php array with a few built in features
 * @package Library
 * @subpackage Type_Array
 * @copyright DCoda Ltd
 * @author DCoda Ltd
 ...
 * $LastChangedBy$
 */
class DCode_Type_Array extends DCode_Type_Abstract implements Iterator, ArrayAccess, Serializable, Countable
{
	...
	private function convert ()
	{
		...
		foreach ($this->value as $key => $value) {
			if (is_array($value)) {
				$this->value[$key] = new DCode_Type_Array($this->application(),$value);
			}
		}
	}
	// iterator functions
