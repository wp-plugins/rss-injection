<?php
/**
 * values and derived values for wordpress plugins.
 * @package Library
 * @subpackage WP_Values
 * @copyright DCoda Ltd
 * @author DCoda Ltd
 ...
 * $LastChangedBy$
 */
class DCode_WP_Values extends DCode_Values
{
	const scope_blog = 1;
	const scope_site = 2;
	...
	public static function WP_SiteURL ($value = '')
	{
		if (is_null(self::$WP_SiteURL)) {
			self::$WP_SiteURL = DCode_Type_String::staticAddEnding(get_option('siteurl'), '/');
		}
