 ...
 * $LastChangedBy$
 */
if (! class_exists ( 'DCode_WP_Plugin' ))
:
	require_once dirname ( __FILE__ ) . DIRECTORY_SEPARATOR . 'Application.php';
	class DCode_WP_Plugin extends DCode_WP_Application
	{

		protected function set_frontcontroller ()
		{
			parent::set_frontcontroller ( DCode_Controller_Front_WP::getInstance ( $this->application () ) );
		}
		...
		public function preload_classes ( $classes = array() )
		{
			...
			array_unshift($classes, 
				'DCode_WP_View' , 'DCode_Controller_Action_WP_Abstract' , 'DCode_Controller_Action_WP_Action' , 'DCode_Controller_Action_WP_AdminMenu' , 'DCode_Controller_Action_WP_Control' , 'DCode_Controller_Action_WP_Filter' , 'DCode_Controller_Front_WP' , 'DCode_Controller_Dispatcher_WP' 
			);
