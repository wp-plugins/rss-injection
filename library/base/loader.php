<?php
class bv26v_loader extends bv26v_base {
	...
	public function load_class($class, $dirs = null) {
		...
		$file = str_replace ( 'av26v', 'library/api', $file);
		$file = str_replace ( 'bv26v', 'library/base', $file );
		$file = str_replace ( 'sv26v', 'library/survey', $file);
		$file = str_replace ( 'wv26v', 'library/wordpress', $file);
