<?php
class bv21v_loader extends bv21v_base {
	...
	public function load_class($class, $dirs = null) {
		...
		$file = str_replace ( 'av21v', 'library/api', $file);
		$file = str_replace ( 'bv21v', 'library/base', $file );
		$file = str_replace ( 'sv21v', 'library/survey', $file);
		$file = str_replace ( 'wv21v', 'library/wordpress', $file);
