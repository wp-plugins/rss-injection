<?php
class bv27v_loader extends bv27v_base {
	...
	public function load_class($class, $dirs = null) {
		...
		$file = str_replace ( 'av27v', 'library/api', $file);
		$file = str_replace ( 'bv27v', 'library/base', $file );
		$file = str_replace ( 'sv27v', 'library/survey', $file);
		$file = str_replace ( 'wv27v', 'library/wordpress', $file);
