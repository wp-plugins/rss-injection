<?php
class bv25v_loader extends bv25v_base {
	...
	public function load_class($class, $dirs = null) {
		...
		$file = str_replace ( 'av25v', 'library/api', $file);
		$file = str_replace ( 'bv25v', 'library/base', $file );
		$file = str_replace ( 'sv25v', 'library/survey', $file);
		$file = str_replace ( 'wv25v', 'library/wordpress', $file);
