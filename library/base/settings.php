<?php
class bv21v_settings extends bv21v_controller_action {
	...
	public function all()
	{
		if(null===$this->_settings)
		{
			...
			foreach($array as $setting)
			{
				...
				$combined_settings=bv21v_type_array::merge_replace_recursive($combined_settings,$xml);
			}
			if(isset($combined_settings['xml']))
			{
				...
				{
					$xml = $this->render_script($dir.$setting);
					$combined_settings=bv21v_type_array::merge_replace_recursive($xml,$combined_settings);
				}
			}
