<?php
class bv27v_type_array extends bv27v_type_abstract implements Iterator, ArrayAccess, Serializable, Countable {
	...
	private function convert() {
		foreach ( $this->value as $key => $value ) {
			if (is_array ( $value )) {
				$this->value [$key] = new bv27v_type_array ( $this->application (), $value );
			}
		}
	}
	// iterator functions
