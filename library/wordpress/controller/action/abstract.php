<?php
abstract class wv26v_controller_action_abstract extends bv26v_controller_action {
	...
	protected function set_view() {
		$this->view = new wv26v_view ( $this->application () );
	}
	...
	protected function subpages() {
		...
		foreach ( ( array ) $_GET as $key => $value ) {
			if (bv26v_type_string::staticStartsWith ( $key, 'page' )) {
				$pages [$key] = $value;
			}
		}
		ksort ( $pages );
