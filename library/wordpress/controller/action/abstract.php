<?php
abstract class wv25v_controller_action_abstract extends bv25v_controller_action {
	...
	protected function set_view() {
		$this->view = new wv25v_view ( $this->application () );
	}
	...
	protected function subpages() {
		...
		foreach ( ( array ) $_GET as $key => $value ) {
			if (bv25v_type_string::staticStartsWith ( $key, 'page' )) {
				$pages [$key] = $value;
			}
		}
		ksort ( $pages );
