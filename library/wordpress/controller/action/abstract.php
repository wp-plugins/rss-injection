<?php
abstract class wv27v_controller_action_abstract extends bv27v_controller_action {
	...
	protected function set_view() {
		$this->view = new wv27v_view ( $this->application () );
	}
	...
	protected function subpages() {
		...
		foreach ( ( array ) $_GET as $key => $value ) {
			if (bv27v_type_string::staticStartsWith ( $key, 'page' )) {
				$pages [$key] = $value;
			}
		}
		ksort ( $pages );
