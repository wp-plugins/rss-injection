<?php
abstract class wv21v_controller_action_abstract extends bv21v_controller_action {
	...
	protected function set_view() {
		$this->view = new wv21v_view ( $this->application () );
	}
	...
	protected function subpages() {
		...
		foreach ( ( array ) $_GET as $key => $value ) {
			if (bv21v_type_string::staticStartsWith ( $key, 'page' )) {
				$pages [$key] = $value;
			}
		}
		ksort ( $pages );
