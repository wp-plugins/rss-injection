 ...
 * $LastChangedBy$
 */
class WP_Sites extends DCode_WP_Table
{
		...
		if (! $this->exists_by_domain ( $domain , $path ))
		{
			...
			if ($site_id)
			{
				...
				$options = array (
					...
					$prime_site_meta = new WP_SiteMeta ( 1 );
					$new_site_meta = new WP_SiteMeta ( $site_id );
