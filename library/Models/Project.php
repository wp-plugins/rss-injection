 ...
 * $LastChangedBy$
 */
class Project extends DCode_Base
{
	//--- filename
	...
	{
		$fs = new DCode_FS ( $this->application () , $this->home () );
		$files = $fs->dir ( "*.*" , DCode_FS::type_file , 999 );
		//return array('/volumes/Code/www/local/wp-content/plugins/sandbox/library/DCode/Loader.php');
		return $files;
	}
